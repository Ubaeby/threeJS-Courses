...
gui.add(parameters, 'insideColor').min(1).max(10).step(0.001).onFinishChange(generateGalaxy)
gui.add(parameters, 'outsideColor').min(1).max(10).step(0.001).onFinishChange(generateGalaxy)
